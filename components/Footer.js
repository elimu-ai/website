  ...
  return (
    <footer className="py-16 px-6 lg:px-16 flex flex-col items-center">
      ...
      <p className="mt-9 text-center">
        ...
        <Link href='https://www.drips.network/app/drip-lists/41305178594442616889778610143373288091511468151140966646158126636698' aria-label='Visit Drips page'>Support 💜</Link>
      </p>
    </footer>
  );
}
